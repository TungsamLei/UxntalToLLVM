...
public class ex01_1_test {
    /**
     * Test whether the program can compile the ex01_1_simple_calc.tal correctly.
     *
     * @throws Exception
     */
    @Test
    public void ex01_0_test() throws Exception {
        ...
        Map<String, List<String>> tal = readUxntalFile.splitBlock(readUxntalFile.readUxntalTest("ex01_1_simple_calc"));
...
//            System.out.println(labelLLVM);
        ...
        Assert.assertEquals("ex01_1_test failed","define i16 @main() {\n" +
        ...
        System.out.println("ex01_1_test pass successfully.");
    }
}
