...
public class ex01_3_test {
    /**
     * Test whether the program can compile the ex01_3_simple_calc.tal correctly.
     *
     * @throws Exception
     */
    @Test
    public void ex01_3_test() throws Exception {
        ...
        Map<String, List<String>> tal = readUxntalFile.splitBlock(readUxntalFile.readUxntalTest("ex01_3_simple_calc"));
...
//            System.out.println(labelLLVM);
        ...
        System.out.println("ex01_3_test pass successfully.");
    }
}
